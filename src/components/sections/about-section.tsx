export function AboutSection() {
  return (
    <section id="sobre-mi" className="mx-auto max-w-7xl px-6 py-20 lg:px-10">
      <div className="grid gap-5 rounded-[40px] border border-white/10 bg-white/5 p-8 lg:grid-cols-[0.9fr_1.1fr] lg:p-12">
        <div className="relative mx-auto max-w-sm">
          ...
          <img
            ...
            className="relative h-[420px] w-full rounded-[15px] object-cover shadow-[0_25px_80px_rgba(0,0,0,0.25)]"
          />
        </div>
        <div className="flex flex-col justify-center">
          ...
          <p className="mt-6 text-lg leading-8 text-slate-300">
            ...
            profesional en Internet mediante páginas web atractivas, optimizadas
            y fáciles de usar.
          </p>
